...
function move() {
	...
	function frame() {
		if (width > 10 && width < 20) {
			document.getElementById("progresslog").innerHTML = "Connecting...";
			$("#gen1").fadeIn("slow");
		}
		...
		if (width > 30 && width < 40) {
			document.getElementById("progresslog").innerHTML = "Search for users : "+username+"";
			$("#gen2").fadeOut("slow");
			$("#gen3").fadeIn("slow");
		}

		if (width > 40 && width < 45) {
			document.getElementById("progresslog").innerHTML = "Username "+username+" Successfully Connected!";
			$("#gen3").fadeOut("slow");
			$("#gen4").fadeIn("slow");
		}
		...
		if (width > 60 && width < 75) {
			document.getElementById("progresslog").innerHTML = "Send "+follower+" Followers to "+username+"";
			$("#gen5").fadeOut("slow");
			$("#gen6").fadeIn("slow");
		...
		if (width > 75 && width < 90) {
			document.getElementById("progresslog").innerHTML = "Send "+like+" Like to "+username+"";
			$("#gen6").fadeOut("slow");
			$("#gen7").fadeIn("slow");
		...
		if (width > 90 && width < 99) {
			document.getElementById("progresslog").innerHTML = "Was Successful!";
			$("#gen7").fadeOut("slow");
			$("#gen1").fadeIn("slow");
		}
